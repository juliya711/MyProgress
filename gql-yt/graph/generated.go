...
func (ec *executionContext) field_Mutation_createJobListing_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNCreateJobListingInput2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐCreateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) field_Mutation_updateJobListing_argsInput(
	...
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNUpdateJobListingInput2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐUpdateJobListingInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNJobListing2ᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListing(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteJobListing(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDeleteJobResponse2ᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_jobs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.JobListing)
	fc.Result = res
	return ec.marshalNJobListing2ᚕᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListingᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateJobListingInput2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐCreateJobListingInput(ctx context.Context, v interface{}) (model.CreateJobListingInput, error) {
	res, err := ec.unmarshalInputCreateJobListingInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNDeleteJobResponse2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v model.DeleteJobResponse) graphql.Marshaler {
	return ec._DeleteJobResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNDeleteJobResponse2ᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐDeleteJobResponse(ctx context.Context, sel ast.SelectionSet, v *model.DeleteJobResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNJobListing2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v model.JobListing) graphql.Marshaler {
	return ec._JobListing(ctx, sel, &v)
}

func (ec *executionContext) marshalNJobListing2ᚕᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListingᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.JobListing) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNJobListing2ᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListing(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNJobListing2ᚖgithubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐJobListing(ctx context.Context, sel ast.SelectionSet, v *model.JobListing) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNUpdateJobListingInput2githubᚗcomᚋjuliya711ᚋgqlᚑytᚋgraphᚋmodelᚐUpdateJobListingInput(ctx context.Context, v interface{}) (model.UpdateJobListingInput, error) {
